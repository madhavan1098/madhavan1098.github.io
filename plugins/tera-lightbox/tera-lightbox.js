...
(function($) {
    ...
    var $lightboxContainer = $('<div id="lightbox"><div class="controls"><div class="galleryPrev"><img src="/img/ui/arrow-back-outline.svg" alt="icon" class="icon"/></div><div class="galleryNext"><img src="/img/ui/arrow-forward-outline.svg" alt="icon" class="icon"/></div><div class="galleryClose"><img src="/img/ui/close-outline.svg" alt="icon" class="icon"/></div></div>');
